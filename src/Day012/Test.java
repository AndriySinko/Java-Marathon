...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        User user3 = new User("Матвей");
        user3.sendMessage(user1,"Здарова");
        user3.sendMessage(user1,"Давай сегодня встретимся в кафе");
        user3.sendMessage(user1,"Какое время тебе подходит?");
        user1.sendMessage(user3,"Привет");
        user1.sendMessage(user3,"Да, хорошо");
        user1.sendMessage(user3,"В 17:00 освобожусь");
        user3.sendMessage(user1,"Хорошо, до встречи");
